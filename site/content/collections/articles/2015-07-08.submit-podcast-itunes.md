...
article_content:
  ...
  -
    ...
    text: |
      ...
      </ol><p>Initially, for my first podcast, I hosted the website + feed on WordPress, and the files on Amazon S3. I thought it would save me money; I was wrong!</p><p>I ended up spending $20-$30 per month on AWS bills. It turns out, bandwidth is expensive!</p><p>That's why Jon and I started&nbsp;<a href="https://transistor.fm/?utm_source=justinjackson.ca&amp;utm_medium=link&amp;utm_campaign=jjlinks">Transistor.fm</a>.&nbsp;</p><p>We'll give you everything you need for $19/month:</p><ul><li>A website for your podcast<br></li><li>Fast MP3 hosting on our CDN</li><li>An iTunes-ready RSS feed</li><li>Landing pages for each episode (sample)</li><li>Detailed podcast analytics</li></ul>
  -
    type: image
  ...
  -
    type: text
    text: '<p>We also have a podcast player that you can embed on your website, landing page, or on Twitter:</p>'
  -
    type: html_embed
  ...
  -
    ...
    text: |
      ...
      <li>Find an online community that would be interested in the show. Examples: Product Hunt, Designer News, or a <g class="gr_ gr_43 gr-alert gr_spell gr_inline_cards gr_run_anim ContextualSpelling ins-del multiReplace" id="43" data-gr-id="43">sub-reddit</g> on Reddit.</li>
