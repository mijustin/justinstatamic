...
article_content:
  ...
  -
    type: sidebar
    text: |
      <em>Here are some of the replies to this post I've receive so far:</em>
      
      <div style="border-width: 3px; border-style: ridge; border-radius: 255px 25px 225px 25px/25px 225px 25px 255px; padding:10px;">
      
      <h4>Anonymous says:</h4>
        <blockquote>"A pessimist is a well-informed optimist."<cite>– old proverb</cite></blockquote>
      </div>
