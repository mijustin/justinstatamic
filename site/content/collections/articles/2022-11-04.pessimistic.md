...
article_content:
  ...
  -
    ...
    text: |
      ...
      <div style="border-width: 2px; border-style: solid; border-radius: 15px 125px 15px 155px/ 155px 15px 125px 15px; padding:10px; margin-bottom:20px">
      ...
      <div style="border-width: 3px; border-style: ridge; border-radius: 255px 25px 225px 25px/25px 225px 25px 255px; padding:10px; margin-bottom:20px">
      
      <h4>Anonymous says:</h4>
        <p>"A pessimist is a well-informed optimist."<br>– old proverb</p>
      </div>
      
      <div style="border-width: 2px; border-style: solid; border-radius: 15px 125px 15px 155px/ 155px 15px 125px 15px; padding:10px;">
