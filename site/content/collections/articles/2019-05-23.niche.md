...
article_content:
  ...
  -
    type: text
    text: '<p>Typically, we start our funnels with "number of visitors," but in reality, the funnel looks like this:&nbsp;</p>'
  -
    type: sidebar
