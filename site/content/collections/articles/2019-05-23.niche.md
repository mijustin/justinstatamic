...
article_content:
  ...
  -
    type: text
    text: '<p>If you want, you can still start by targeting a niche within a larger market. But don''t plan of capturing 100% of an already small market. As a bootstrapper, that''s just not tenable.</p><p>Typically, we start our funnels with "number of visitors," but in reality, the funnel looks like this:&nbsp;</p>'
  -
    type: sidebar
