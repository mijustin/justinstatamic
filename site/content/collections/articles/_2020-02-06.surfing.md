...
article_content:
  ...
  -
    ...
    text: |
      ...
      x
      growth rate (increase in # of customers, spending, frequency)</li><li><b>Market reach</b> = can you reach a reasonable number of potential customers? What reliable marketing channels exist?</li><li><b>Personal advantages</b> = what are the skills, experiences, and connections you bring to the table?</li></ol><p><br></p>
