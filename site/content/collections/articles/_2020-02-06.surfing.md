...
article_content:
  ...
  -
    type: sidebar
    text: '**Sidenote:** even experienced entrepreneurs often need to go back to the "learn to surf" phase when they jump into a new industry or product category. This is why ego is so harmful for founders. When building something new, you go down to the bottom of the ladder. You, once again, become a student.'
  -
    type: text
