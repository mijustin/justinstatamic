...
article_content:
  ...
  -
    type: text
    text: '<p>The same is true in business!&nbsp;</p><p>Using the same hill chart model, we could illustrate the process of building a business like this:</p><p><b>The "Developing Fundamentals" stage:</b></p><ul><li>Gaining relevant skills</li><li>Making connections</li><li>Understanding a market or industry</li><li>Observing demand</li></ul>'
  -
    type: image
