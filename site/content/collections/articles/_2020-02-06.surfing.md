...
article_content:
  ...
  -
    ...
    text: |
      ...
      x
      growth rate (increase in # of customers, spending, frequency)</li><li><b>Market reach</b> = what % of the potential customers can you realistically reach?</li><li><b>Personal advantages</b> = what are the skills, experiences, and connections you bring to the table?</li></ol><p><br></p>
