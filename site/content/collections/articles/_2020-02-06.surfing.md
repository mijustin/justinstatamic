...
article_content:
  ...
  -
    type: text
    text: |
      <h2>What makes a good market?</h2><p>Here are the factors you'll want to consider when evaluating market demand:</p><ol><li><b>Current market value</b> =
      ...
      x
      growth rate (increase in # of customers, spending, frequency)</li><li><b>Market reach</b> = what % of the potential customers can you realistically reach?</li></ol>
