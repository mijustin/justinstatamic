...
article_content:
  ...
  -
    type: text
    text: '<p>Likewise, the first steps to launching a business won''t be "build a software product." You''ll need to work on your fundamentals first.</p><p>Using the same hill chart model, we could illustrate the process of building a business like this:</p>'
  -
    type: image
