...
article_content:
  ...
  -
    type: text
    text: |
      <p>I want (need?) more of that energy in my life. I think we all do.</p><h3>Public discourse</h3><p>In retrospect, the advent of Twitter, Facebook, and other "short-form, text-based" social media, didn't improve our public discourse.</p><p>Sam Harris echoed the thoughts of many when he left Twitter:</p><blockquote><p>"I just came to believe that my engagement with Twitter was making me a worse person.
