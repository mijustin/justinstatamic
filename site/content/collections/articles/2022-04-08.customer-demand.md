...
article_content:
  -
    type: text
    text: '<p>Contrary to popular belief, entrepreneurs don''t "create" the underlying demand for a product.</p><p>While companies certainly have some influence over what customers desire, customer demand is, broadly, determined by multiple factors, many of which are outside of our control.</p><p>Here''s how demand for products gets created, amplified, and destroyed.</p><h2>New products evolve on top of existing demand</h2><p>Most new products are an evolution of older products and benefit from pre-existing demand.</p><p>Take, for example, cameras:</p>'
  -
    type: image
