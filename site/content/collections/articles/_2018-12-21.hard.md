...
article_content:
  ...
  -
    type: text
    text: '<p>Yes, isolation can remove distractions, and allow us to focus on bringing ideas to life. But it''s hard to show up every day, by yourself. When there''s no one to cheer you on and no one to be accountable to, it''s easier to give up.</p><p>To go the distance, get people in your corner!</p>'
