...
article_content:
  ...
  -
    type: text
    text: '<p>This was followed by trip to a family resort, where we swam in the pool, zip-lined, and went waterskiing.</p><p>Just as we were easing into summer vacation, the fires in BC came. For most of July and August we lived under a fiery red sky, filled toxic smoke and ash. It was truly awful. Being in thick smoke, not being able to go outside, and not being able to escape it, made me feel helpless.</p>'
  -
    type: image
