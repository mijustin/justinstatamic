...
article_content:
  ...
  -
    type: text
    text: '<p>Now we can see the danger of letting Amazon control all the distribution. Once they own the whole pie, "it is in their interest," as <a href="https://thisten.co/ltmam">Seth Godin</a> says, "to pay workers and small businesses less."</p><h2>How the system keeps us powerless</h2><p>Most Main Street businesses, solopreneurs, and bootstrappers follow the "American dream" philosophy. The idea is that we, as individuals, can strike out on our own and create our own wealth. So each of us starts building our own little silo, hoping that it will gain enough traction to</p>'
