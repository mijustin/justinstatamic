...
article_content:
  -
    type: text
    text: '<p>If there''s one skill that''s helpful for leveling-up your career (or your business) it''s <b>public speaking</b>.</p><p>This isn''t just about getting on stage at a conference (although that''s part of it).</p><p><b>This is about learning to be a good communicator.</b></p><p>When you''re comfortable in front of a group of people,&nbsp;</p><p>For me, learning to give a talk has unlocked dozens of new opportunities:</p><ul><li>It''s been a conduit for getting job offers, raises, podcast interviews, and product sales.<br></li></ul><blockquote>"I recommend speaking at conferences – it&nbsp;helps you meet people and is also a clear ''Hey, I know what I''m doing and I can write good code'' signal to the world." – Stephanie Hurlburt</blockquote><p><br></p><p><b>But, for many, the idea of giving a talk is terrifying.</b></p>'
  -
    type: image
