...
/**
 * Plugin Name: WP Static Site Generator (Premium)
...
if ( !function_exists( 'wpsho_fr' ) ) {
    ...
    {
        wp_add_dashboard_widget( 'wp_static_html_output_dashboard_widget', 'Static HTML Output', 'wp_static_html_output_dashboard_widget_function' );
    }
    ...
    wpsho_fr()->add_filter(
        ...
        'wpsho_fr_custom_connect_message_on_update',
        10,
        6
    );
    wpsho_fr()->add_filter(
